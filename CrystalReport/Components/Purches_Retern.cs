...
{
    public partial class Purches_Retern : UserControl
    {
        ...
        private string GenerateInvoice()
        {
            ...
            try
            {
                var sql = "select * from Purches_Return";
                ...
                inv = $"PRT{DateTime.Now.ToString("yy")}{DateTime.Now.ToString("MM")}{DateTime.Now.ToString("dd")}{custsr}{srn}";
    ...
    dataGridView1.Rows[e.RowIndex].Cells[7].Value != null)
                ...
                try
                {
                    ...
                    if (dataGridView1.Rows.Count > 0)
                    {
                        for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
                        {
                            ...
                            await MainEngine_.Add(dynamic, "InsertPurchesItemsReturn");
                    ...
                    await MainEngine_.Add(smodel, "InsertPurchesReturn");
        ...
        private void parties_Click(object sender, EventArgs e)
        {
            try
            {
                View c = new View("View_Purches", "GetReport");
                c.Show();
        ...
        private void textBox2_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = $"SELECT billdate FROM Bill WHERE items = '{textBox2.Text}'";
                ...
                supid.Text = MainEngine_.GetDataScript<string>("select spid  from Bill where BillID = '"+textBox2.Text+"'").FirstOrDefault();
        ...
        private void main_datagrid_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if(main_datagrid.Rows.Count >=1)
                {
                    ...
                    hsn.Text = main_datagrid.Rows[e.RowIndex].Cells[1].Value.ToString();
