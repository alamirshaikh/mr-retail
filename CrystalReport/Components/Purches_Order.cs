...
{
    public partial class Purches_Order : UserControl
    {
        ...
        private string GenerateInvoice()
        {
            ...
            try
            {
                var sql = "select * from Purches_Order";
                ...
                inv = $"ORD{DateTime.Now.ToString("yy")}{DateTime.Now.ToString("MM")}{DateTime.Now.ToString("dd")}{custsr}{srn}";
                ...
                try
                {
                    ...
                    if (dataGridView1.Rows.Count > 0)
                    {
                        for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
                        {
                            ...
                            await MainEngine_.Add(dynamic, "p_orderitems");
                    ...
                    string terms = string.IsNullOrEmpty(richTextBox1.Text.Trim()) ? "" : richTextBox1.Text.Trim();
                    ...
                    await MainEngine_.Add(smodel, "InsertPorder");
                ...
                if (checkBox1.Checked)
                {
                    ...
                    if (nextIndex < dgview.Rows.Count)
                    {
                        ...
                        if (dgview.Rows[nextIndex].Cells[0].Value != null)
                        {
                            ...
                            if (comboBox1.SelectedIndex == 1 || comboBox1.Text == "GST")
                            {
                                gsttext.Text = dgview.Rows[nextIndex].Cells[4].Value.ToString();
